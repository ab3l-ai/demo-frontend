...
import { ChainId, STSW, SUSHI, Token, WNATIVE } from 'core-sdk'
...
import * as LOCAL from './tokens/localhost'
import * as REMOTE from './tokens/remotehost'
...
const WRAPPED_NATIVE_ONLY: ChainTokenList = {
  ...
  [ChainId.LOCALHOST_TEST]: [WNATIVE[ChainId.LOCALHOST_TEST]],
  [ChainId.REMOTEHOST_TEST]: [WNATIVE[ChainId.REMOTEHOST_TEST]],
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.LOCALHOST_TEST]:[
    ...WRAPPED_NATIVE_ONLY[ChainId.LOCALHOST_TEST],
    LOCAL.USDC,
    LOCAL.DAI
  ],
  [ChainId.REMOTEHOST_TEST]:[
    ...WRAPPED_NATIVE_ONLY[ChainId.REMOTEHOST_TEST],
    REMOTE.USDC,
    REMOTE.DAI
  ],
}
...
export const COMMON_BASES: ChainTokenList = {
  ...
  [ChainId.BOBA_AVAX]: [...WRAPPED_NATIVE_ONLY[ChainId.BOBA_AVAX], BOBA_AVAX.AVAX],
  [ChainId.LOCALHOST_TEST]: [...WRAPPED_NATIVE_ONLY[ChainId.LOCALHOST_TEST], LOCAL.STSW],
  [ChainId.REMOTEHOST_TEST]: [...WRAPPED_NATIVE_ONLY[ChainId.REMOTEHOST_TEST], LOCAL.STSW],
}
